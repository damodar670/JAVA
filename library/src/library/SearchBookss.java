...
public class SearchBookss extends Frame implements ActionListener {
Label l1,l2,l3,l4,l5,l6,l7,l8,l9,l10;
TextField t1,t2;
Button b1,b2,b3;
String s4;
SearchBookss(String h)
{setFont(new Font("serif",Font.BOLD,18));
   ...
   l5=new Label("author :");
   t1=new TextField(30);
   b1.setBounds(100,50,40,20);
   b2.setBounds(100,420,40,20);
   b3.setBounds(150,420,50,20);
...
public void actionPerformed(ActionEvent e)
{
  ...
  if(b3==e.getSource())
  {
	  ...
	  IssueBooks i=new IssueBooks(s4,a);
		    i.setSize(1000,1000);
		    i.setVisible(true);
