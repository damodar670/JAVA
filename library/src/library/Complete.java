		  ...
		  try {
			 String s6="avail";
			  Class.forName("com.mysql.jdbc.Driver");
			   ...
			   PreparedStatement statement12 = con.prepareStatement("select noBookIssued from student where sid="+Integer.parseInt(s4)+";"); 
			   ResultSet result1=statement12.executeQuery();
				  ...
				  d1=d1-1;
			 PreparedStatement statement11 = con.prepareStatement("update student set  noBookIssued= '"+d1+"'where sid= "+Integer.parseInt(s4)+";");
			 statement11.executeUpdate();
			 PreparedStatement statement13 = con.prepareStatement("update books set status= '"+s6+"',sid=null"+",dateofp=null"+" where bookid="+b+";");
			 statement13.executeUpdate();
			 PreparedStatement statement14 = con.prepareStatement("delete from transaction where sid="+Integer.parseInt(s4)+" and bookid="+b+";");
